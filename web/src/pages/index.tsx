            ...
            <div className="relative text-white mt-10 pt-10 px-[12.5vw] bg-black text-center">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p>
                  ...
                  instrument for speaking the language of music. This instrument
                  will give you the ability to express oneself on a grand level.
                </p>
              </div>
            ...
            <div className="flex max-sm:flex-col md:flex-row-reverse items-center gap-10 mb-[80px] px-[12.5vw]">
              <div className="w-[100%] flex flex-col gap-3">
                <p>
                  ...
                  <i>
                    "another person in the world who has found their passion for
                    music."
                  </i>
                </p>
                <p>
                  I love being a piano teacher and good music is what I strive
                  for. Creating good music takes patience and hard work, however
                  my methodology involves fostering the student’s passion, not
                  constraining it. I purely want what the student wants, whether
                  that is playing for music examinations, leisure or playing
                  piano in a band! As mentioned before, good music takes
                  patience and hard work. What I strive for is{" "}
                  <strong>
                    making the process of practice a pleasurable experience
                  </strong>
                  . Unfortunately in life, you have to endure the hard to get to
                  the easy. I aim to make this process meaningful, and most
                  importantly, fun!
                </p>
        ...
        <Container>
          <div className="px-[12.5vw]">
            ...
            <p>
              ...
              your interest in receiving lessons. Whether or not lessons will be
              available at a given time is subject to change, so please make
              sure to give a time range that works for you, and we can follow up
              if need be.
            </p>
            <br />
